...
#
# The MBR disk signature is hardcoded to 0x4c503348 in mksdimg.sh.
# Partition layout: 1=FAT boot (PARTUUID=4c503348-01), 2=rootfs (PARTUUID=4c503348-02).
# U-Boot reads extlinux/extlinux.conf from the FAT boot partition (partition 1).
# This file is for rootfs reference only; the authoritative boot config is
# generated by mkcustomrootfs.sh into build/input/boot.fat.
#
